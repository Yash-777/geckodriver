    ...
    fn from_webdriver_message(id: u64,
        ...
        let (opt_name, opt_parameters) = match msg.command {
            NewSession(_) => {
                ...
                let mut capabilities_obj = BTreeMap::new();
                capabilities_obj.insert("desiredCapabilities".to_string(), caps.to_json());
                data.insert("capabilities".to_string(), capabilities_obj.to_json());
